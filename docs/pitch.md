...
**Core Loop (3–5 sentences):** User action The user selects a venue → Details of venues and past/upcoming shows → Options to save venue/shows pops up → User saves venues and events.